...
Чтобы на чать работу с удаленными репозиториями(соих или чужих Open Source) , нужно зарегестрироваться на одном из ресурсов, например GitHab. После регистрации, на сайте можно начать новый проект или присоедениться к одному из множества Open Source проектов. 
