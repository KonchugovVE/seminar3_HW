...
### Как предложить свои изменения в проекте?

После всех изменений и работ , ваши изменения готовы и вы хотели бы ими поделиться? Для этого нужно на сайте GitHab , далее страничка этого проекта в вашем личном кабинете, нажать кнопку 'Pull requests'. После нажатия, решени по принятию изменений будет принимать хозяин этого проекта.